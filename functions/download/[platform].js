...
const PLATFORM_RELEASES = {
  'mac-arm64': { tag: 'node-ui-v0.8.59', file: 'Synapseia.Node_0.8.59_aarch64.dmg' },
  'mac-x64':   { tag: 'node-ui-v0.8.59', file: 'Synapseia.Node_0.8.59_x64.dmg' },
  'windows':   { tag: 'node-ui-v0.8.59', file: 'Synapseia.Node_0.8.59_x64_en-US.msi' },
  'linux':     { tag: 'node-ui-v0.8.59', file: 'Synapseia.Node_0.8.59_amd64.AppImage' },
};
