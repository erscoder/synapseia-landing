...
const PLATFORM_RELEASES = {
  'mac-arm64': { tag: 'node-ui-v0.8.40', file: 'Synapseia.Node_0.8.40_aarch64.dmg' },
  'mac-x64':   { tag: 'node-ui-v0.8.40', file: 'Synapseia.Node_0.8.40_x64.dmg' },
  'windows':   { tag: 'node-ui-v0.8.40', file: 'Synapseia.Node_0.8.40_x64_en-US.msi' },
  'linux':     { tag: 'node-ui-v0.8.40', file: 'Synapseia.Node_0.8.40_amd64.AppImage' },
};
