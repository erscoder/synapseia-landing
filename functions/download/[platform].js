...
const PLATFORM_RELEASES = {
  'mac-arm64': { tag: 'node-ui-v0.8.58', file: 'Synapseia.Node_0.8.58_aarch64.dmg' },
  'mac-x64':   { tag: 'node-ui-v0.8.58', file: 'Synapseia.Node_0.8.58_x64.dmg' },
  'windows':   { tag: 'node-ui-v0.8.58', file: 'Synapseia.Node_0.8.58_x64_en-US.msi' },
  'linux':     { tag: 'node-ui-v0.8.58', file: 'Synapseia.Node_0.8.58_amd64.AppImage' },
};
