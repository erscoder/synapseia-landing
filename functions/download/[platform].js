...
const PLATFORM_RELEASES = {
  'mac-arm64': { tag: 'node-ui-v0.8.60', file: 'Synapseia.Node_0.8.60_aarch64.dmg' },
  'mac-x64':   { tag: 'node-ui-v0.8.60', file: 'Synapseia.Node_0.8.60_x64.dmg' },
  'windows':   { tag: 'node-ui-v0.8.60', file: 'Synapseia.Node_0.8.60_x64_en-US.msi' },
  'linux':     { tag: 'node-ui-v0.8.60', file: 'Synapseia.Node_0.8.60_amd64.AppImage' },
};
