...
const PLATFORM_RELEASES = {
  'mac-arm64': { tag: 'node-ui-v0.8.46', file: 'Synapseia.Node_0.8.46_aarch64.dmg' },
  'mac-x64':   { tag: 'node-ui-v0.8.46', file: 'Synapseia.Node_0.8.46_x64.dmg' },
  'windows':   { tag: 'node-ui-v0.8.46', file: 'Synapseia.Node_0.8.46_x64_en-US.msi' },
  'linux':     { tag: 'node-ui-v0.8.46', file: 'Synapseia.Node_0.8.46_amd64.AppImage' },
};
